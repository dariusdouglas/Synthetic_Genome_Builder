...
amino_acid_to_codon_sum = {1: "q", "j": 2, "v": 3, "p": 4, "g": 5, "w": 6, "u": 7, "l": 8, "r": 9, "s": 10, "i": 11,
                           "a": 12,
                           "e": 13, "t": 14, "o": 15, "n": 16, "h": 17, "d": 18, "c": 19, "m": 20, "f": 21, "y": 22,
                           "b": 23,
                           "k": 24, "x": 25, "z": 26}
...
def convert_protein_to_nucleotide_sequence(potential_protein):
    ...
    nums = []
    potential_protein = potential_protein.decode("utf-8")
...
def main(*args):
    ...
    for all_proteins in list(args):
        ...
        for protein in all_proteins:
            ...
            # /2
            if num_proteins_added < len(all_proteins) + 1:
