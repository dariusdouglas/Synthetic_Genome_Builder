...
# SYNTHETIC GENOME
scrambled_genome = "2689307000952689151999268921400999552689679319990268932333000752689267700001526890255999812689592" \
                   "599930"
    ...
    while index < len(strand_5_to_3):
        for segment in segments_in_strand:
            ...
            if len(current_frame) == 3:
                ...
                or int(current_frame[0]) + int(current_frame[1]) + int(current_frame[2]) == stop_codon[1] and not neg:
